...
function SubmitButton(){
     ...
     const submittedBasicform = useSelector((state) => state.basicForm.submittedBasicform);
      const submittedLifestyleForm = useSelector((state) => state.lifestyleForm.submittedLifestyleForm);
       const submittedMedicalhistoryForm = useSelector((state) => state.medicalHistoryForm.submittedMedicalhistoryForm);
